...
from sklearn.datasets import load_svmlight_file as get_data_from_svmlight_file
...
def run_devnet(args):
    ...
    for nm in names:
        ...
        std_aucpr = np.std(ap)
        train_time = train_time / k_folds
        test_time = test_time / k_folds
...
parser.add_argument("--output", type=str, default='./results/devnet_result.csv', help="the output file path")
parser.add_argument("--ramdn_seed", type=int, default=42, help="the random seed number")
parser.add_argument("--k_folds", type=int, default=5, help="the number of folds for k-fold cross-validation")
